...
import * as THREE2 from "/virtual-people/vendor/three/webgpu";
import { cos, mat2, sin, uv, vec2, vec4 } from "/virtual-people/vendor/three/tsl";

// src/nodes/materialReferences.ts
import { materialReference } from "/virtual-people/vendor/three/tsl";
...
import * as THREE4 from "/virtual-people/vendor/three/webgpu";
import { BRDF_Lambert, diffuseColor, float, mix, transformedNormalView, vec3 } from "/virtual-people/vendor/three/tsl";

// src/nodes/immutableNodes.ts
import * as THREE3 from "/virtual-people/vendor/three/webgpu";
import { nodeImmutable } from "/virtual-people/vendor/three/tsl";
...
import * as THREE_TSL from "/virtual-people/vendor/three/tsl";
import * as THREE_WEBGPU from "/virtual-people/vendor/three/webgpu";
var FnCompat = (jsFunc) => {
...
import * as THREE5 from "/virtual-people/vendor/three/webgpu";
import {
  ...
  vec3 as vec32,
  vec4 as vec42
} from "/virtual-people/vendor/three/tsl";
...
import { float as float2, modelViewPosition, transformedNormalView as transformedNormalView2 } from "/virtual-people/vendor/three/tsl";
