...
本地 DevTools 与 H5 smoke 可以使用 `http://localhost:8851`。真机预览、体验版和正式版统一使用
小程序专用 H5 业务域名 `https://aiedu-mp.intelledu.cn`，普通 Web 站点继续保留
`https://aiedu.intelledu.cn`，两条线互不覆盖。
