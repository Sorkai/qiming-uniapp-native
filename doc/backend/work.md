...
- **接口地址**：`/edu/backend/v1/course/exam/list`- **请求方式**：GET
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/exam/question/list`- **请求方式**：GET
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/course/exam/create`- **请求方式**：POST
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/course/exam/update`- **请求方式**：POST
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/course/exam/delete`- **请求方式**：POST
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/exam/question/batch/add`- **请求方式**：POST
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/course/homework/list`- **请求方式**：GET
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/homework/question/list`- **请求方式**：GET
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/course/homework/create`- **请求方式**：POST
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/course/homework/update`- **请求方式**：POST
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/course/homework/delete`- **请求方式**：POST
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/homework/question/batch/add`- **请求方式**：POST
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/work/delete/question`- **请求方式**：POST
- **请求参数**：
...
- **接口地址**：`/edu/backend/v1/work/round/add/question`- **请求方式**：POST
- **请求参数**：
