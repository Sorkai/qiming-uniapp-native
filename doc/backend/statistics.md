...
- **接口地址**：`/edu/backend/v1/statistics/teacher/usage`- **请求方式**：GET
- **请求参数**：无
- **响应参数**：
...
- **接口地址**：`/edu/backend/v1/statistics/student/usage`- **请求方式**：GET
- **请求参数**：无
- **响应参数**：
...
- **接口地址**：`/edu/backend/v1/statistics/efficient/index`- **请求方式**：GET
- **请求参数**：无
- **响应参数**：
...
- **接口地址**：`/edu/backend/v1/statistics/week/usage`- **请求方式**：GET
- **请求参数**：无
- **响应参数**：
...
- **接口地址**：`/edu/backend/v1/statistics/course/users/progress`- **请求方式**：GET
- **请求参数**：无
- **响应参数**：
...
- **接口地址**：`/edu/backend/v1/statistics/course/users/exam/info`- **请求方式**：GET
- **请求参数**：无
- **响应参数**：
