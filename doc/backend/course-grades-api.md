...
- **接口路径**：`GET /edu/frontend/v1/course/grades/statistics`
- **请求参数**：
...
- **接口路径**：`GET /edu/frontend/v1/course/grades/list`
- **请求参数**：
...
- **接口路径**：`GET /edu/frontend/v1/course/grades/class-comparison`
- **请求参数**：
...
2. **空数据处理**：
   - 如果学生没有任何提交记录，`averageScore` 可返回 `0` 或 `null`
   - `list` 为空时返回空数组 `[]`
