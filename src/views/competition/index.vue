<template>
  <div class="main">
    ...
    <el-row :gutter="16" class="module-cards">
      <el-col :span="6">
        <el-card class="module-card oj-card" shadow="hover">
          <div class="module-icon">💻</div>
          <div class="module-info">
            <h3>在线 OJ</h3>
            <p>{{ ojStats.totalProblems }} 道题目 / {{ ojStats.submissions }} 次提交</p>
          </div>
        </el-card>
      </el-col>
      <el-col :span="6">
        <el-card class="module-card training-card" shadow="hover">
          <div class="module-icon">📚</div>
          <div class="module-info">
            <h3>题库训练</h3>
            <p>{{ trainingStats.categories }} 分类 / {{ trainingStats.questions }} 道题</p>
          </div>
        </el-card>
      </el-col>
      <el-col :span="6">
        <el-card class="module-card essay-card" shadow="hover">
          <div class="module-icon">✍️</div>
          <div class="module-info">
            <h3>作文批改</h3>
            <p>{{ essayStats.totalEssays }} 篇作文 / 平均 {{ essayStats.avgScore }} 分</p>
          </div>
        </el-card>
      </el-col>
      <el-col :span="6">
        <el-card class="module-card security-card" shadow="hover">
          <div class="module-icon">🛡️</div>
          <div class="module-info">
            <h3>知识竞赛</h3>
            <p>{{ securityStats.participants }} 人参与</p>
          </div>
        </el-card>
      </el-col>
    </el-row>
...
const ojStats = ref({ totalProblems: 500, submissions: 12580 });
const trainingStats = ref({ categories: 12, questions: 3000 });
const essayStats = ref({ totalEssays: 856, avgScore: 78 });
