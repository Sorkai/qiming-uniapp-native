  ...
  <div class="app-container">
    <el-card>
      ...
      <div class="filter-container">
        ...
        <el-button class="filter-item" type="primary" :icon="Upload" @click="handleUpload">
          上传文件
        </el-button>
      </div>
...
const fileList = ref([
  { name: "课程介绍.pptx", size: "2.3 MB", createTime: "2023-10-01 10:00", url: "#" },
  { name: "第一章：Vue基础.pdf", size: "5.1 MB", createTime: "2023-10-02 14:30", url: "#" },
  { name: "第二章：组件化开发.docx", size: "1.2 MB", createTime: "2023-10-05 09:00", url: "#" },
  { name: "期中项目要求.zip", size: "10.5 MB", createTime: "2023-10-10 16:45", url: "#" },
  { name: "教学视频-1.mp4", size: "128 MB", createTime: "2023-10-12 11:20", url: "#" },
  { name: "学生成绩表.xlsx", size: "350 KB", createTime: "2023-10-15 18:00", url: "#" }
]);
