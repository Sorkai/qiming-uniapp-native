...
@media (max-width: 768px) {
  .exam-do-container {
    min-width: 0;
    padding-bottom: var(--pure-mobile-content-bottom-gap, 120px);
  }
  ...
  .exam-header {
    ...
    gap: 10px 12px;
    align-items: center;
    padding: calc(var(--pure-safe-area-top, 0px) + 10px) 12px 12px;
  ...
  .question-content {
    ...
    .question-options {
      ...
      .matrix-wrapper {
        ...
        .matrix-row {
          min-width: 520px;
          grid-template-columns: 140px repeat(auto-fit, minmax(72px, 1fr));
        }
      }
