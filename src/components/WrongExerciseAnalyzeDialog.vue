<template>
  ...
  >
    <div v-loading="loading" class="wea-body">
      <section class="orig">
        <h3 class="section-title">原题</h3>
        <div class="stem" v-html="origContent" />
      ...
      <section
        v-if="generatedExercises && generatedExercises.length"
        class="generated"
      >
        <div class="section-header">
          <h3 class="section-title">
            相似练习（{{ generatedExercises.length }}）
          </h3>
        </div>
        <div class="exercise-list">
          ...
          >
            <div class="q-header">
              ...
              <div class="q-text" v-html="ex.question" />
            </div>
            ...
            <el-collapse-transition>
              <div v-show="showExplain[idx]" class="explain">
                <div v-if="ex.correct_answer" class="right-ans">
...
const origContent = computed(
  () => props.original?.original_exercise_content || ""
);
const analysis = computed<WrongExerciseAnalyzeResponse["analysis"] | null>(
  () => props.response?.analysis || null
);
const generatedExercises = computed<GeneratedExercise[]>(
  () => props.response?.generated_exercises || []
);
